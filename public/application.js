...
/***/ function(module, exports, __webpack_require__) {
	...
	var kitchenEvents = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(function () {
	    onSignIn(event, data);
	  }).then(ui.signUpSuccess).catch(ui.signUpFail);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    ...
	    return store.user;
	  }).then(ui.signInSuccess).catch(ui.signInFail);
	  // $('#sign-in')[0].reset();
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).then(ui.changePwSuccess).catch(ui.changePwFail);
	};
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.signOutSuccess).catch(ui.signOutFail);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signedInKitchens = __webpack_require__(12);
	var kitchenEvents = __webpack_require__(32);
	...
	var changePwFail = function changePwFail(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"signed-in-user-kitchen\">\n<!--Create a New Kitchen  -->\n  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#kitchen-create\">\n        New Kitchen Listing\n      </button>\n\n  <!-- Modal form to create new kitchen-->\n  <div class=\"modal kapat\" id=\"kitchen-create\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" id=\"myModalLabel\">New Listing</h4>\n        </div>\n        <div class=\"modal-body\">\n\n          <form class='create-kitchen'>\n            <input type=\"text\" name=\"kitchen[kitchen_name]\" placeholder=\"Enter Kitchen Name\" class=\"clean-update\">\n            <input type=\"text\" name=\"kitchen[location]\" placeholder=\"Enter Kitchen Location\" class=\"clean-update\">\n            <input type=\"text\" name=\"kitchen[phone_number]\" placeholder=\"123-456-7890\" class=\"clean-update\">\n            <input type=\"text\" name=\"kitchen[email]\" placeholder=\"contact@contact.com\"  class=\"clean-update\">\n            <input type=\"text\" name=\"kitchen[available_hours]\" placeholder=\"Monday-Friday, 9AM - 9PM\" class=\"clean-update\">\n\n            <textarea rows=\"10\" cols=\"35\" type=\"text\" name=\"kitchen[description]\" placeholder=\"List your kitchen's features and equipment\" class=\"clean-update\"></textarea>\n            <button type=\"submit\" class=\"btn btn-default create-kitchen\"> Save Listing</button>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n  <!-- index kitchens -->\n  <button type=\"button\" class=\"btn btn-default sign-in-show\">My Kitchen listings</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexKitchens = function onIndexKitchens(event) {
	  event.preventDefault();
	  api.indexKitchens().then(ui.indexKitchensSuccess).catch(ui.indexError);
	};

	var onIndexKitchensSignedIn = function onIndexKitchensSignedIn(event) {
	  event.preventDefault();
	  // const data = event
	  api.indexKitchensSignedIn().then(ui.indexKitchensSignedIn).catch(ui.indexError);
	};

	var onCreateKitchen = function onCreateKitchen(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createKitchen(data).then(function (response) {
	    store.kitchen = response.kitchen;
	    ui.createSuccess(response.kitchen);
	  }).then(api.indexKitchensSignedIn).then(ui.indexKitchensSignedIn).catch(ui.createError);
	};

	var onShowKitchen = function onShowKitchen(event) {
	  event.preventDefault();
	  var kitchenId = $('#kitchen-id').val();
	  if (kitchenId.length === 0) {} else {
	    api.showKitchen(kitchenId).then(ui.showKitchenSuccess).catch(ui.showError);
	  }
	};

	var onDeleteKitchen = function onDeleteKitchen(event) {
	  event.preventDefault();
	  api.destroyKitchen($(this).data('id')).then(ui.deleteSuccess).then(api.indexKitchensSignedIn).then(ui.indexKitchensSignedIn).catch(ui.error);
	};

	var onUpdateKitchen = function onUpdateKitchen(event) {
	  event.preventDefault();
	  var info = getFormFields(event.target);
	  api.updateKitchen(info, $(this).data('id')).then(ui.updateSuccess).then(api.indexKitchensSignedIn).then(ui.indexKitchensSignedIn).catch(ui.error);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onIndexKitchens: onIndexKitchens,
	  onIndexKitchensSignedIn: onIndexKitchensSignedIn,
	  onCreateKitchen: onCreateKitchen,
	  onDeleteKitchen: onDeleteKitchen,
	  onUpdateKitchen: onUpdateKitchen,
	  onShowKitchen: onShowKitchen
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createKitchen = function createKitchen(data) {
	  return $.ajax({
	...
	var indexKitchens = function indexKitchens() {
	  return $.ajax({
	    url: config.apiOrigin + '/kitchens',
	...
	var indexKitchensSignedIn = function indexKitchensSignedIn() {
	  return $.ajax({
	...
	var showKitchen = function showKitchen(id) {
	  return $.ajax({
	...
	var destroyKitchen = function destroyKitchen(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/kitchens/' + id,
	    headers: {
	      Authorization: 'Token token=' + store.user.token
	...
	var updateKitchen = function updateKitchen(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/kitchens/' + id,
	    method: 'PATCH',
	    headers: {
	...
	module.exports = {
	  indexKitchens: indexKitchens,
	  createKitchen: createKitchen,
	  showKitchen: showKitchen,
	  destroyKitchen: destroyKitchen,
	  updateKitchen: updateKitchen,
	  indexKitchensSignedIn: indexKitchensSignedIn
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showKitchenTemplate = __webpack_require__(35);
	var showKitchenAuth = __webpack_require__(36);

	var indexKitchensSuccess = function indexKitchensSuccess(data) {
	  var showKitchensHtml = showKitchenTemplate({ kitchens: data.kitchens });
	...
	var indexKitchensSignedIn = function indexKitchensSignedIn(data) {
	  if (data.kitchens.length === 0) {
	    alertify.error("You don't have any kitchen listings!");
	  }
	  var showKitchensAuthHtml = showKitchenAuth({ kitchens: data.kitchens });
	...
	var showKitchenSuccess = function showKitchenSuccess() {};
	...
	module.exports = {
	  indexKitchensSuccess: indexKitchensSuccess,
	  indexKitchensSignedIn: indexKitchensSignedIn,
	  indexError: indexError,
	  createSuccess: createSuccess,
	  createError: createError,
	  showKitchenSuccess: showKitchenSuccess,
	  showError: showError,
	  error: error,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n   <div class=\"kitchn-card card-1\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n     <h3>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.kitchen_name : stack1), depth0))
	    + "</h3>\n     <br>\n     <br>\n     <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\n          <br>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone_number : stack1), depth0))
	    + "\n           <br>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\n           <br>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.available_hours : stack1), depth0))
	    + "\n           <br>\n        "
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.kitchens : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n   <div class=\"card card-1\" data-id=\""
	    ...
	    + "\n                <br>\n             "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\n          </p>\n\n     <!-- Button trigger modal -->\n     <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#mod"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n       Update!\n     </button>\n\n     <!-- Modal -->\n     <div class=\"modal kapat\" id=\"mod"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n       <div class=\"modal-dialog\" role=\"document\">\n         <div class=\"modal-content\">\n           <div class=\"modal-header\">\n             <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n             <h4 class=\"modal-header\" id=\"myModalLabel\">Update!</h4>\n           </div>\n           <div class=\"modal-body\">\n             <form class=\"submit-kitchen-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                 <input type=\"text\" name=\"kitchen[kitchen_name]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.kitchen_name : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"text\" name=\"kitchen[location]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"text\" name=\"kitchen[phone_number]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone_number : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"text\" name=\"kitchen[email]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"text\" name=\"kitchen[available_hours]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.available_hours : stack1), depth0))
	    + "\" class=\"clean-update\">\n\n                 <textarea rows=\"10\" cols=\"35\" type=\"text\" name=\"kitchen[description]\" class=\"clean-update\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</textarea>\n                 <!-- <input type=\"submit\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"submit\"> -->\n                 <button type=\"submit\" class=\"btn btn-default update-kitchen\"> Update Listing</button>\n\n             </form>\n             <div class=\"warning-update-data\">\n\n             </div>\n           </div>\n           <div class=\"modal-footer\">\n             <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n           </div>\n         </div>\n       </div>\n     </div>\n\n     <button type=\"button\" name=\"button\" class=\"btn btn-default remove-kitchen\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button>\n   </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
